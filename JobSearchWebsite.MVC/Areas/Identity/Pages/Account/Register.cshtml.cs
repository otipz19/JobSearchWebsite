...
namespace JobSearchWebsite.MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
	{
		...
		{
			//Create app roles
			if (!await _roleManager.RoleExistsAsync(AppUserRoleType.Admin.ToString()))
			{
				await _roleManager.CreateAsync(new IdentityRole(AppUserRoleType.Admin.ToString()));
				await _roleManager.CreateAsync(new IdentityRole(AppUserRoleType.Company.ToString()));
				await _roleManager.CreateAsync(new IdentityRole(AppUserRoleType.Jobseeker.ToString()));
			}
